...
#define rotationCount -16 													//how much it will rotate, may have to test + and - (16.5 also goes over)
#define powerPercentage 3											//how much power to rotate at
...
#define clawServoPosition 43											//How far to move the claw servo.

/**************************************MAIN CODE - DO NOT TOUCH*********************************************/

void moveServo(int sec, int power){
	servo[ArmServo] = 127 + power;
	wait1Msec(sec*1000);
	servo[ArmServo] = 117;
}
