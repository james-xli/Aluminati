...
#define SERVOHIGHBAND(x) ( (((x) > 255))? 255: (x))
#define SERVOLOWBAND(x) ( ((x) < 0)? 0: (x))

#define TIME_INTERVAL 100
int claw_servo_angle = ServoValue[clawServo];
...
void arm_servos( int hat, int btn5 )
{
	...
	if (hat == 4)
  	servo[armServo1] = 200; //moving
 		...
 		servo[armServo1] = 110; //holding with rings, decrease to add power
	else
