...
#pragma config(Motor,  mtr_S1_C1_2,     BLWheel,       tmotorTetrix, openLoop)
#pragma config(Motor,  mtr_S1_C2_1,     BRWheel,       tmotorTetrix, openLoop, reversed)
#pragma config(Motor,  mtr_S1_C2_2,     FRWheel,       tmotorTetrix, openLoop, reversed)
